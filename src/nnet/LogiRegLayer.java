...
public class LogiRegLayer implements NNInterface{
	...
	public LogiRegLayer(int xLength)
	{
		this(xLength, 0);
	}
	
	public LogiRegLayer(int length, int linkId)
	{
		this.length = length;
		this.linkId = linkId;
	...
	public void link(NNInterface nextLayer, int id) throws Exception {
		// TODO Auto-generated method stub
		double[] nextI = (double[]) nextLayer.getInputG(id);
		double[] nextIG = (double[])nextLayer.getInput(id); 
	...
	public Object cloneWithTiedParams() {
		// TODO Auto-generated method stub
		LogiRegLayer clone = new LogiRegLayer(length, linkId);
		return clone;
	}
