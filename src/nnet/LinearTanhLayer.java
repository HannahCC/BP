...
public class LinearTanhLayer implements NNInterface {
	...
	public LinearTanhLayer(){

	}
	public LinearTanhLayer(LinearLayer seedLinear) throws Exception{
	...
	public LinearTanhLayer(int xInputLength,int xOutputLength) throws Exception{
	...
	public Object cloneWithTiedParams() {
		// TODO Auto-generated method stub
		LinearTanhLayer clone = new LinearTanhLayer();
